...
st.markdown("<h6 style='text-align: center; color: #555; background-color: rgba(192, 192, 192, 0.5); padding: 10px; border-radius: 10px;'>Ingat, Hasil Ini Hanya Prediksi Berdasarkan Data yang Anda Masukan.</h4>", unsafe_allow_html=True)
# Membagi kolom
